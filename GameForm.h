...
namespace BallisticGame {
	...
	private: System::Windows::Forms::TrackBar^ MassTrackBar; // Ползунок для массы
	private: System::Windows::Forms::TrackBar^ SpeedTrackBar; // Ползунок для скорости
	private: System::Windows::Forms::TrackBar^ AngleTrackBar; // Ползунок для угла
	protected:

	protected:

 
	private: System::Windows::Forms::Button^ ShootButton; // Кнопка выстрела 
	private: System::Windows::Forms::PictureBox^ GamePictureBox; // Поле для отображения

	private: System::Windows::Forms::Label^ MassLabel; // Метка для массы
	private: System::Windows::Forms::Label^ SpeedLabel; // Метка для скорости 
	private: System::Windows::Forms::Label^ AngleLabel; // Метка для угла 
	private: System::Windows::Forms::Label^ LeftPlayerLabel; // Метка для левого игрока 
	private: System::Windows::Forms::Label^ RightPlayerLabel; // Метка для праваого игрока
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ShootButton->Text = L"Выстрел!";
			...
			this->MassLabel->Size = System::Drawing::Size(40, 13);
			...
			this->SpeedLabel->Size = System::Drawing::Size(55, 13);
			this->SpeedLabel->TabIndex = 6;
			this->SpeedLabel->Text = L"Скорость";
			// 
			// Лейбл для угла
			// 
			...
			this->AngleLabel->Size = System::Drawing::Size(32, 13);
			this->AngleLabel->TabIndex = 7;
			this->AngleLabel->Text = L"Угол";
			this->AngleLabel->Click += gcnew System::EventHandler(this, &GameForm::AngleLabel_Click);
			// 
			// Лейбл для левого игрока 
			// 
			this->LeftPlayerLabel->AutoSize = true;
			this->LeftPlayerLabel->Location = System::Drawing::Point(217, 91);
			this->LeftPlayerLabel->Name = L"LeftPlayerLabel";
			this->LeftPlayerLabel->Size = System::Drawing::Size(125, 13);
			this->LeftPlayerLabel->TabIndex = 8;
			this->LeftPlayerLabel->Text = L"Левый игрок стреляет!";
			// 
			// Лейбл лоя правого игрока 
			// 
			this->RightPlayerLabel->AutoSize = true;
			this->RightPlayerLabel->Location = System::Drawing::Point(429, 91);
			this->RightPlayerLabel->Name = L"RightPlayerLabel";
			this->RightPlayerLabel->Size = System::Drawing::Size(131, 13);
			this->RightPlayerLabel->TabIndex = 9;
			this->RightPlayerLabel->Text = L"Правый игрок стреляет!";
...
private: System::Void AngleLabel_Click(System::Object^ sender, System::EventArgs^ e) {
}
};
}
